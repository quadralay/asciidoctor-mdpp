...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Tony McDow"]
  spec.email = ["mcdow@webworks.com"]

  spec.summary = "Convert Asciidoctor documents to Markdown++."
  spec.description = "Customer Ruby converter for Asciidoctor to Markdown++."
  spec.homepage = "https://www.webworks.com"
  spec.license = "MIT"
